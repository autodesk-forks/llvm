...
TEST_F(LinkModuleTest, ImportIntrinsicGlobalVariables_ctors1) {
  ...
  ASSERT_FALSE(L.linkInModule(std::move(Src),
                              Linker::LinkOnlyNeeded |
                                  Linker::InternalizeLinkedSymbols));
...
TEST_F(LinkModuleTest, ImportIntrinsicGlobalVariables_ctors3) {
  ...
  ASSERT_FALSE(L.linkInModule(std::move(Src1),
                              Linker::LinkOnlyNeeded |
                                  Linker::InternalizeLinkedSymbols));

  ASSERT_FALSE(L.linkInModule(std::move(Src2),
                              Linker::LinkOnlyNeeded |
                                  Linker::InternalizeLinkedSymbols));
